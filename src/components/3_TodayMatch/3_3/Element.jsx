    ...
    <div className="element">
      <div className="div-2">
        <div className="overlap">
          ...
          <div className="group-wrapper">
            <div className="overlap-group-wrapper">
              <div className="overlap-group">
                <div className="text-wrapper-4">2023년 8월18일 금요일</div>
              </div>
            </div>
          </div>
          <div className="div-4">
            <img className="img" alt="Rectangle" src="/img/rectangle-68.png" />
            <div className="text-wrapper-2">닉네임 2</div>
            <div className="frame">
          ...
          <div className="div-5">
            <img className="img" alt="Rectangle" src="/img/rectangle-68.png" />
            <div className="text-wrapper-2">닉네임 3</div>
            <div className="frame">
              <p className="text-wrapper-3">내 가슴 깊숙히 보물과 같이</p>
            </div>
            <div className="frame-2">
          ...
          <div className="div-wrapper-3">
            <div className="div-6">
              <div className="frame-3">
                <div className="text-wrapper-5">갤러리</div>
                <img className="img-2" alt="Insert photo" src="/img/insert-photo.svg" />
              </div>
              <div className="frame-4">
                <div className="text-wrapper-6">사진촬영</div>
                <img className="img-2" alt="Photo camera" src="/img/photo-camera.svg" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="view-2">
          ...
          <p className="p">
            ...
            <span className="text-wrapper-7">청춘</span>
          </p>
        ...
        <div className="frame-wrapper">
          <div className="frame-5">
            <div className="view-6">
              <img className="img-4" alt="Search" src="/img/search.svg" />
              <div className="text-wrapper-11">친구찾기</div>
            </div>
            <div className="view-6">
              <div className="text-wrapper-11">친구목록</div>
              <img className="img-4" alt="Person" src="/img/person.svg" />
            </div>
            <div className="view-7">
              <div className="text-wrapper-12">오늘의 인연</div>
              <img className="auto-awesome" alt="Auto awesome" src="/img/auto-awesome.svg" />
            </div>
            <div className="div-9">
              <div className="text-wrapper-13">1:1 대화방</div>
